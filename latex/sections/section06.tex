...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{images/imagen3.png}
...
\hline
\textbf{RESULTADO OBTENIDO} & El usuario es registrado correctamente y se almacena en la base de datos. \\
\hline
...
\hline
\textbf{RESULTADO OBTENIDO} & El sistema rechaza el registro y muestra mensajes de validación indicando los errores encontrados. \\
\hline
\textbf{ESTADO} & APROBADO \\
\hline
\end{tabular}
...
\hline
\textbf{RESULTADO OBTENIDO} & El sistema autentica al usuario, genera un JWT y permite el acceso al sistema. \\
\hline
\textbf{ESTADO} & APROBADO \\
\hline
\end{tabular}
...
\hline
\textbf{RESULTADO OBTENIDO} & El sistema devuelve un error de autenticación (HTTP 401) e impide el acceso. \\
\hline
\textbf{ESTADO} & APROBADO \\
\hline
\end{tabular}
...
\hline
\textbf{RESULTADO OBTENIDO} & El sistema bloquea temporalmente la IP o el usuario e impide nuevos intentos de autenticación. \\
\hline
\textbf{ESTADO} & APROBADO \\
\hline
\end{tabular}
...
\hline
\textbf{RESULTADO OBTENIDO} & El sistema devuelve HTTP 403 Forbidden y niega el acceso. \\
\hline
\textbf{ESTADO} & APROBADO \\
\hline
\end{tabular}
...
\hline
\textbf{RESULTADO OBTENIDO} & El sistema permite el acceso al panel del Supervisor. \\
\hline
\textbf{ESTADO} & APROBADO \\
\hline
\end{tabular}
...
\hline
\textbf{RESULTADO OBTENIDO} & El sistema responde con HTTP 401 Unauthorized. \\
\hline
\textbf{ESTADO} & APROBADO \\
\hline
\end{tabular}
...
\hline
\textbf{RESULTADO OBTENIDO} & El sistema rechaza la solicitud y responde con HTTP 401 Unauthorized. \\
\hline
\textbf{ESTADO} & APROBADO \\
\hline
\end{tabular}
...
\hline
\textbf{RESULTADO OBTENIDO} & El sistema genera un nuevo Access Token válido y mantiene la sesión del usuario activa. \\
\hline
\textbf{ESTADO} & APROBADO \\
\hline
\end{tabular}
