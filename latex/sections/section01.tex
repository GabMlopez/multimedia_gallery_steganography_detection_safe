...
La Galería de Imágenes Segura es una aplicación web que permite a los usuarios subir, organizar y compartir imágenes en álbumes, con la característica diferenciadora de detectar contenido oculto mediante análisis de esteganografía (anomalías EOF, firmas embebidas y metadatos EXIF). El sistema incluye 4 subsistemas principales: autenticación y autorización, gestión de imágenes y álbumes, motor de detección de esteganografía con cuarentena, y panel de supervisor para auditoría. La Figura 1-1 identifica los CI dentro de cada subsistema y destaca aquellos a los que se aplica este Plan SQA.
...
\hline
Plan de Aseguramiento de Calidad & SQAP & CI-01 \\
\hline
Plan de Pruebas de Software & STP & CI-04 \\
\hline
Reporte de Pruebas de Software & STR & CI-05 \\
\hline
Documentación de Usuario & UDP & CI-06 \\
\hline
Guía de Despliegue & DEP & CI-07 \\
\hline
\end{tabular}
\end{table}
...
\caption{Software de Galería de Imágenes Segura}
\label{fig:system}
\end{figure}
...
La Sección 12 describe la revisión de SQA del proceso de Gestión de Riesgos.
