...
\begin{enumerate}
    \item \underline{Gerente SQA} --- [Nombre] es responsable de:
    \begin{enumerate}
    ...
    \item \underline{Gerente de Programa} --- [Nombre] es responsable de:
    \begin{enumerate}
        \item Establecer la política de calidad del proyecto y comprometer al equipo a implementar los estándares de ingeniería de software.
        ...
        \item Identificar los factores de calidad a implementar en el sistema y el software (seguridad, confiabilidad, usabilidad).
        \item Proporcionar los recursos necesarios para llevar a cabo las actividades SQA.
    \end{enumerate}
    ...
    \item \underline{Ingeniería de Sistemas} --- [Nombre] es responsable de:
    \begin{enumerate}
    ...
    \item \underline{Diseño/Desarrollo de Software} --- [Nombre] es responsable de:
    \begin{enumerate}
        \item Revisar y comentar el Plan SQA del proyecto.
        \item Implementar el programa de calidad de acuerdo con este Plan SQA.
    ...
    \item \underline{Pruebas} --- [Nombre] es responsable de:
    \begin{enumerate}
        \item Revisar y comentar el Plan SQA del proyecto.
        \item Implementar el programa de calidad de acuerdo con este Plan SQA.
        ...
        \item Reportar hallazgos y registrar discrepancias en el Formulario de Reporte de Discrepancias (DCR).
    \end{enumerate}
\end{enumerate}
...
\hline
Gerente SQA & [Nombre] & [Cédula] & 100\% \\
\hline
Gerente de Programa & [Nombre] & [Cédula] & 100\% \\
\hline
Gerente de Proyecto & [Nombre] & [Cédula] & 100\% \\
\hline
Ingeniería de Sistemas & [Nombre] & [Cédula] & 100\% \\
\hline
Desarrollo de Software & [Nombre] & [Cédula] & 100\% \\
\hline
Pruebas & [Nombre] & [Cédula] & 100\% \\
\hline
\end{tabular}
\end{table}
